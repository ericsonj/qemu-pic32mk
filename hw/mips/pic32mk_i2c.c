...
{
    switch (base) {
    case PIC32MK_I2CxCON:  return &s->con;
    case PIC32MK_I2CxSTAT: return &s->stat;
    case PIC32MK_I2CxADD:  return &s->add;
    case PIC32MK_I2CxMSK:  return &s->msk;
    case PIC32MK_I2CxTRN:  return &s->trn;
    case PIC32MK_I2CxRCV:  return &s->rcv;
    default:               return NULL;
    }
}
