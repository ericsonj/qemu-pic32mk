...
static void spi_update_irq(PIC32MKSpiState *s)
{
    ...
    bool rx_pending;
    switch (srxisel) {
    case 0:  rx_pending = (s->rx_count == 0); break;
    case 1:  rx_pending = (s->rx_count > 0);  break;
    case 2:  rx_pending = (s->rx_count >= depth / 2); break;
    case 3:  rx_pending = (s->rx_count >= depth); break;
    default: rx_pending = false; break;
    }
    ...
    bool tx_pending;
    switch (stxisel) {
    case 0:  tx_pending = (s->tx_count == 0); break;
    case 1:  tx_pending = (s->tx_count == 0); break;
    case 2:  tx_pending = (s->tx_count <= depth / 2); break;
    case 3:  tx_pending = (s->tx_count < depth); break;
    default: tx_pending = false; break;
    }
