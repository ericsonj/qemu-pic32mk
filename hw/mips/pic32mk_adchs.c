...
{
    switch (base) {
    case PIC32MK_ADCCON1:     return &s->adccon1;
    case PIC32MK_ADCCON2:     return &s->adccon2;
    case PIC32MK_ADCCON3:     return &s->adccon3;
    case PIC32MK_ADCTRGMODE:  return &s->adctrgmode;

    case PIC32MK_ADCIMCON1:   return &s->adcimcon[0];
    case PIC32MK_ADCIMCON2:   return &s->adcimcon[1];
    case PIC32MK_ADCIMCON3:   return &s->adcimcon[2];
    case PIC32MK_ADCIMCON4:   return &s->adcimcon[3];

    case PIC32MK_ADCGIRQEN1:  return &s->adcgirqen[0];
    case PIC32MK_ADCGIRQEN2:  return &s->adcgirqen[1];

    case PIC32MK_ADCCSS1:     return &s->adccss[0];
    case PIC32MK_ADCCSS2:     return &s->adccss[1];

    case PIC32MK_ADCDSTAT1:   return &s->adcdstat[0];
    case PIC32MK_ADCDSTAT2:   return &s->adcdstat[1];

    case PIC32MK_ADCCMPEN1:   return &s->adccmpen[0];
    case PIC32MK_ADCCMPEN2:   return &s->adccmpen[1];
    case PIC32MK_ADCCMPEN3:   return &s->adccmpen[2];
    case PIC32MK_ADCCMPEN4:   return &s->adccmpen[3];

    case PIC32MK_ADCCMP1:     return &s->adccmp[0];
    case PIC32MK_ADCCMP2:     return &s->adccmp[1];
    case PIC32MK_ADCCMP3:     return &s->adccmp[2];
    case PIC32MK_ADCCMP4:     return &s->adccmp[3];

    case PIC32MK_ADCFLTR1:    return &s->adcfltr[0];
    case PIC32MK_ADCFLTR2:    return &s->adcfltr[1];
    case PIC32MK_ADCFLTR3:    return &s->adcfltr[2];
    case PIC32MK_ADCFLTR4:    return &s->adcfltr[3];

    case PIC32MK_ADCTRG1:     return &s->adctrg[0];
    case PIC32MK_ADCTRG2:     return &s->adctrg[1];
    case PIC32MK_ADCTRG3:     return &s->adctrg[2];
    case PIC32MK_ADCTRG4:     return &s->adctrg[3];
    case PIC32MK_ADCTRG5:     return &s->adctrg[4];
    case PIC32MK_ADCTRG6:     return &s->adctrg[5];
    case PIC32MK_ADCTRG7:     return &s->adctrg[6];

    case PIC32MK_ADCCMPCON1:  return &s->adccmpcon[0];
    case PIC32MK_ADCCMPCON2:  return &s->adccmpcon[1];
    case PIC32MK_ADCCMPCON3:  return &s->adccmpcon[2];
    case PIC32MK_ADCCMPCON4:  return &s->adccmpcon[3];

    case PIC32MK_ADCBASE:     return &s->adcbase;
    case PIC32MK_ADCTRGSNS:   return &s->adctrgsns;

    case PIC32MK_ADC0TIME:    return &s->adctime[0];
    case PIC32MK_ADC1TIME:    return &s->adctime[1];
    case PIC32MK_ADC2TIME:    return &s->adctime[2];
    case PIC32MK_ADC3TIME:    return &s->adctime[3];
    case PIC32MK_ADC4TIME:    return &s->adctime[4];
    case PIC32MK_ADC5TIME:    return &s->adctime[5];

    case PIC32MK_ADCEIEN1:    return &s->adceien[0];
    case PIC32MK_ADCEIEN2:    return &s->adceien[1];
    case PIC32MK_ADCEISTAT1:  return &s->adceistat[0];
    case PIC32MK_ADCEISTAT2:  return &s->adceistat[1];

    case PIC32MK_ADCANCON:    return &s->adcancon;

    case PIC32MK_ADC0CFG:     return &s->adccfg[0];
    case PIC32MK_ADC1CFG:     return &s->adccfg[1];
    case PIC32MK_ADC2CFG:     return &s->adccfg[2];
    case PIC32MK_ADC3CFG:     return &s->adccfg[3];
    case PIC32MK_ADC4CFG:     return &s->adccfg[4];
    case PIC32MK_ADC5CFG:     return &s->adccfg[5];
    case PIC32MK_ADC6CFG:     return &s->adccfg[6];
    case PIC32MK_ADC7CFG:     return &s->adccfg[7];

    case PIC32MK_ADCSYSCFG0:  return &s->adcsyscfg[0];
    case PIC32MK_ADCSYSCFG1:  return &s->adcsyscfg[1];
