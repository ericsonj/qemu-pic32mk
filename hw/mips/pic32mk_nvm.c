...
static uint64_t nvm_read(void *opaque, hwaddr addr, unsigned size)
{
    ...
    switch (base) {
    case PIC32MK_NVMCON:    return s->nvmcon;
    case PIC32MK_NVMKEY:    return 0;   /* write-only */
    case PIC32MK_NVMADDR:   return s->nvmaddr;
    case PIC32MK_NVMDATA0:  return s->nvmdata[0];
    case PIC32MK_NVMDATA1:  return s->nvmdata[1];
    case PIC32MK_NVMDATA2:  return s->nvmdata[2];
    case PIC32MK_NVMDATA3:  return s->nvmdata[3];
    case PIC32MK_NVMSRCADDR: return s->nvmsrcaddr;
    case PIC32MK_NVMPWP:    return s->nvmpwp;
    case PIC32MK_NVMBWP:    return s->nvmbwp;
    case PIC32MK_NVMCON2:   return s->nvmcon2;
    default:
        qemu_log_mask(LOG_UNIMP,
