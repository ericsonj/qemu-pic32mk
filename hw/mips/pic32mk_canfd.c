...
static uint64_t canfd_sfr_read(void *opaque, hwaddr offset, unsigned size)
{
    ...
    switch (base_off) {
    case CANFD_CiCON:    return s->con;
    case CANFD_CiNBTCFG: return s->nbtcfg;
    case CANFD_CiDBTCFG: return s->dbtcfg;
    case CANFD_CiTDC:    return s->tdc;
    case CANFD_CiTBC:    return s->tbc;
    case CANFD_CiTSCON:  return s->tscon;
    case CANFD_CiVEC:    return s->vec;
    case CANFD_CiINT:    return s->cint;
    case CANFD_CiRXIF:   return s->rxif;
    case CANFD_CiTXIF:   return s->txif;
    case CANFD_CiRXOVIF: return s->rxovif;
    case CANFD_CiTXATIF: return 0;
    case CANFD_CiTXREQ:  return s->txreq;
    case CANFD_CiTREC:   return s->trec;
