...
static uint64_t pic32mk_cfg_read(void *opaque, hwaddr addr, unsigned size)
{
    ...
    case PIC32MK_PMD1:  return s->pmd[0];
    case PIC32MK_PMD2:  return s->pmd[1];
    case PIC32MK_PMD3:  return s->pmd[2];
    case PIC32MK_PMD4:  return s->pmd[3];
    case PIC32MK_PMD5:  return s->pmd[4];
    case PIC32MK_PMD6:  return s->pmd[5];
    case PIC32MK_PMD7:  return s->pmd[6];
                               ...
                               unsigned size)
{
    ...
    case PIC32MK_PMD7: {
        ...
        int idx = (base - PIC32MK_PMD1) / 0x10;
        s->pmd[idx] = apply_sci(s->pmd[idx], v32, sub);
        break;
    }
