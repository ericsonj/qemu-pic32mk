...
|---|---|---|
| [CANFD_IMPLEMENTATION_NOTES.md](CANFD_IMPLEMENTATION_NOTES.md) | CAN FD×4 (CAN1–CAN4) | Complete |
| [SPI_EMULATION.md](SPI_EMULATION.md) | SPI×6 with chardev socket | Complete |
| [INPUT_CAPTURE_EMULATION.md](INPUT_CAPTURE_EMULATION.md) | Input Capture×16 (IC1–IC16) | Complete |
| [OUTPUT_COMPARE_EMULATION.md](OUTPUT_COMPARE_EMULATION.md) | Output Compare×16 (OC1–OC16) | Complete |
| [NVM_FLASH_CONTROLLER_EMULATION.md](NVM_FLASH_CONTROLLER_EMULATION.md) | NVM / Program Flash controller | Complete |
| [DATA_EEPROM_EMULATION.md](DATA_EEPROM_EMULATION.md) | Data EEPROM (4 KB) | Complete |
| [USB_CDC_EMULATION.md](USB_CDC_EMULATION.md) | USB Full-Speed CDC-ACM | Complete |
| [PROGRAM_FLASH_AND_SOFTWARE_RESET.md](PROGRAM_FLASH_AND_SOFTWARE_RESET.md) | Bootloader + pflash write + RSWRST | Complete |
| [CAN2_RX_TASK_PLAN.md](CAN2_RX_TASK_PLAN.md) | CAN2 interrupt-driven RX with FreeRTOS queue | Reference plan |

IRQ vector assignments for all 216 interrupt sources:

| File | Contents |
|---|---|
| [IRQ_TABLE.csv](IRQ_TABLE.csv) | Complete EVIC IRQ table (source, IFS register, bit position) |
