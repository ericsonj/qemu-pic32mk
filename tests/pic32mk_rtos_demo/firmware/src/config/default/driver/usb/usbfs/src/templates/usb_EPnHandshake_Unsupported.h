/*******************************************************************************
  ...
  File Name:
    usb_EPnHandshake_Unsupported.h
...
#ifndef _USB_EPNHANDSHAKE_UNSUPPORTED_H
#define _USB_EPNHANDSHAKE_UNSUPPORTED_H
...
//******************************************************************************
/* Function :  USB_ExistsEPnHandshake_Unsupported

  Summary:
    Implements Unsupported variant of PLIB_USB_ExistsEPnHandshake
...
PLIB_TEMPLATE bool USB_ExistsEPnHandshake_Unsupported(USB_MODULE_ID index) {
    return false;
}

#endif /*_USB_EPNHANDSHAKE_UNSUPPORTED_H*/
