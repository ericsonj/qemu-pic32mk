...
PLIB_TEMPLATE void USB_AllInterruptEnable_Default
(
    USB_MODULE_ID index,
    USB_INTERRUPTS usbInterruptsFlag,
...
//******************************************************************************
/* Function :  USB_InterruptEnableGet_Default

  Summary:
    Implements Default variant of PLIB_USB_InterruptEnableGet
...
PLIB_TEMPLATE USB_INTERRUPTS USB_InterruptEnableGet_Default
(
    USB_MODULE_ID index
) {
    volatile usb_registers_t *usb = ((usb_registers_t *)(index));
    return (USB_INTERRUPTS)(usb->UxIE.w);
}
