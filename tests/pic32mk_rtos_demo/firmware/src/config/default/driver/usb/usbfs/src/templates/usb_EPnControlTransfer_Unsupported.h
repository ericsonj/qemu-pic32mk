/*******************************************************************************
  ...
  File Name:
    usb_EPnControlTransfer_Unsupported.h
...
#ifndef _USB_EPNCONTROLTRANSFER_UNSUPPORTED_H
#define _USB_EPNCONTROLTRANSFER_UNSUPPORTED_H
...
//******************************************************************************
/* Function :  USB_ExistsEPnControlTransfer_Unsupported

  Summary:
    Implements Unsupported variant of PLIB_USB_ExistsEPnControlTransfer
...
PLIB_TEMPLATE bool USB_ExistsEPnControlTransfer_Unsupported(USB_MODULE_ID index) {
    return false;
}

#endif /*_USB_EPNCONTROLTRANSFER_UNSUPPORTED_H*/
